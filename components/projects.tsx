...
export default function Projects() {
  const projects = [
    ...
    {
      id: 8,
      title: "RPA Geocoding API",
      description: "UiPath automation script to retrieve full addresses along with latitude and longitude using the Google Geocoding API.",
      image: "/geocodingAPI.jpg",
      github: "https://github.com/pramudyalyza/RPA-Geocoding-API",
      demo: "https://drive.google.com/file/d/1cNA57g7c7wfQPg_8vx1AoioFcK7_TrmI/view?usp=drive_link",
      presentation: null,
      category: "RPA",
    },
    {
