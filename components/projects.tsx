...
import { Github, ExternalLink, FileIcon as FilePresentation, ChevronLeft, ChevronRight, Video } from "lucide-react"
...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      demo: null,
      presentation: null,
      app: "https://pramudyalyza.vercel.app/chatbot",
      category: "AI & Data Science",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      app: "http://dogbreedclassifierz.streamlit.app/",
      category: "AI & Data Science",
    },
    {
      id: 7,
      ...
      app: "http://iknsentimentapp.streamlit.app/",
      category: "AI & Data Science",
    },
    {
      id: 8,
      title: "Sugar Signal",
      description: "A simple full-stack web app to learn how to serve a diabetes prediction ML model, with the backend on Railway and the frontend on Vercel.",
      image: "/sugarSignal.jpg",
      github: "https://github.com/pramudyalyza/SugarSignal",
      demo: null,
      presentation: null,
      app: "https://sugar-signal.vercel.app/",
      category: "AI & Data Science",
    },
    {
      id: 9,
                  ...
                  <CardFooter className="flex gap-2">
                    ...
                    {project.app && (
                      <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label={`Application for ${project.title}`}
                      >
